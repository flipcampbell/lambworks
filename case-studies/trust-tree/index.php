  ...
  <section class="bg-white">
    ...
    <div class="row">
      <div class="large-10 small-12 small-centered columns text-center">
        <img src="/../images/case-studies/trust-tree/trust-tree-homepage.jpg" alt="Trust Tree Homepage">
      </div> <!-- /.small-10 small-centered columns text-center-->
    </div> <!-- /.row-->
    <h3 class="text-center font-grey">The Story</h3>
    ...
    <h3 class="medium-7 small-12 small-centered columns text-center font-grey">
